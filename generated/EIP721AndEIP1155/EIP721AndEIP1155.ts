...
export class Transfer8 extends ethereum.Event {
  get params(): Transfer8__Params {
    return new Transfer8__Params(this);
  }
}

export class Transfer8__Params {
  _event: Transfer8;

  constructor(event: Transfer8) {
    this._event = event;
  }
...
export class EIP721AndEIP1155 extends ethereum.SmartContract {
  static bind(address: Address): EIP721AndEIP1155 {
    return new EIP721AndEIP1155("EIP721AndEIP1155", address);
  }
  ...
  balanceOf2(_owner: Address): BigInt {
    let result = super.call("balanceOf", "balanceOf(address):(uint256)", [
  ...
  try_balanceOf2(_owner: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("balanceOf", "balanceOf(address):(uint256)", [
      ethereum.Value.fromAddress(_owner)
    ]);
    if (result.reverted) {
